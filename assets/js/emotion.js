...
function Emotion(name, description, example, img){
    this.name = name,
...
var sad = new Emotion("Sad", "sample text", "sample text", "assets/images/sad.png");
...
var curious = new Emotion("Curious", "sample text", "sample text", "sad.png");
...
var emotions = [brave, curious, excited, friendly, happy, impatient, lonely, loved, mad, overwhelmed, peaceful, sad, shy, silly, worried];
...
function createEmotions() {
    ...
    for (let emotion of emotions) {
        ...
        htmlString += '<div class=\"flip-card col-sm-6 col-md-4\" id = \"' + emotion.name + '\"><div class=\"flip-card-inner col-sm-3\"><div class=\"flip-card-front\"><h1>' + emotion.name + '</h1><img src=\"' + emotion.img + '\" alt=\"' + emotion.name + '\" style=\"width:200px;height:200px;\"></div><div class=\"flip-card-back\"><h1>' + emotion.name + '</h1><p>' + emotion.description + '</p><p>' + emotion.example + '</p></div></div></div>';
    }
