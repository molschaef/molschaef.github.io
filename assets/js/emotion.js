...
var happy = new Emotion("Happy", "sample text", "sample text", "assets/images/brave.png", "#");
var sad = new Emotion("Sad", "sample text", "sample text", "assets/images/sad.png", "#265373");
var loved = new Emotion("Loved", "sample text", "sample text", "assets/images/brave.png", "#");
...
var mad = new Emotion("Mad", "sample text", "sample text", "assets/images/brave.png", "#");
// var peaceful = new Emotion("Peaceful", "sample text", "sample text", "assets/images/brave.png", "#");
var overwhelmed = new Emotion("Overwhelmed", "sample text", "sample text", "assets/images/brave.png", "#");
...
var friendly = new Emotion("Friendly", "sample text", "sample text", "assets/images/brave.png", "#");
...
var emotions = [brave, curious, excited, friendly, happy, loved, mad, overwhelmed, sad];
